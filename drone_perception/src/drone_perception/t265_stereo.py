...
class CameraHandler:
    ...
    def __init__(self):
        ...
        self.camera_connected = rospy.get_param("/detector_obstacles/camera_connected")
        ...
        if self.camera_connected:
            ...
            ts = message_filters.ApproximateTimeSynchronizer(
                [left_image_sub, right_image_sub, left_camera_info_sub, right_camera_info_sub], queue_size=10,
                slop=0.05)
            ts.registerCallback(self.synchronized_callback_connected)
        else:
    ...
    def synchronized_main(self, left_image_msg, right_image_msg, K_left, D_left, K_right, D_right):
    ...
    def synchronized_callback(self, left_image_msg, right_image_msg):
        ...
        self.synchronized_main(left_image_msg, right_image_msg, K_left, D_left, K_right, D_right)

    def synchronized_callback_connected(self, left_image_msg, right_image_msg, left_camera_info, right_camera_info):
