...
from drawing import drawSphere, putText, drawCylinder

# Path to your result folders. Example: "/home/rob498/Vicon_Results/"
result_path = "/home/manx52/catkin_ws/src/ROB498/drone/challenges/challenge_4/results/"
# Path to your flight record folder. Example: "team_00_ct3_vicon_free/"
flight_id = "ROB498_Drone-2023-04-12.14:56:30"

# Load the target waypoints here
waypoints = np.load(result_path + flight_id + "/waypoints.npy")
obs_green = np.load(result_path + flight_id + "/obs_green.npy")
obs_red = np.load(result_path + flight_id + "/obs_red.npy")
...
if N_reached_wps > 0:
    ...
    score = N_reached_wps * (1.0 - 1.0 / N_wps * max(0.0, (last_wp_time - 75.0) / 60.0))
else:
    last_wp_time = 0
    score = 0
...
drawCylinder(ax4, obs_green[0, :], 0.5, 2.2, 'g')
drawCylinder(ax4, obs_green[1, :], 0.5, 2.2, 'g')
drawCylinder(ax4, obs_red[0, :], 0.5, 2.2, 'r')
drawCylinder(ax4, obs_red[1, :], 0.5, 2.2, 'r')
