...
result_path = "/home/manx52/catkin_ws/src/ROB498/drone/challenges/challenge_3/results/"
# Path to your flight record folder. Example: "team_00_ct3_vicon_free/"
flight_id = "ROB498_Drone-2023-03-29.19:31:51"
...
ax5.plot3D(flight_data.xs, flight_data.ys, flight_data.zs,linewidth=3)

for idx in range(N_wps):
    color = 'r'
    if idx in reached_wps:
        color = 'g'
    drawSphere(ax5, waypoints[idx,:], tolerance, color)
    putText(ax5, waypoints[idx,:], str(idx))

ax5.set_title('Trajectory in 3D')
ax5.set_xlabel('x (m)')
ax5.set_ylabel('y (m)')
ax5.set_zlabel('m (m)')
